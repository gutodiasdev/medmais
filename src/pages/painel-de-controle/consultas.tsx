              ...
              {Array.from({ length: 10 }).map((item, index) => {
                return (
                  <Tr key={index}>
                    ...
                    <Td >{faker.name.fullName()}</Td>
                    <Td>{faker.date.between('2023-04-01T00:00:00.000Z', '2023-04-10T00:00:00.000Z').toLocaleDateString('pt-br')}</Td>
                    <Td>
                      <HStack
                        justifyContent={'flex-end'}
                      >
                        <Tooltip label={'Ver consulta'} borderRadius={'md'}>
                          <IconButton
                        ...
                        <Tooltip label={'Editar consulta'} borderRadius={'md'}>
                          <IconButton
                        ...
                        <Tooltip label={'Excluir consulta'} borderRadius={'md'} bg={'red'}>
                          <IconButton
                            aria-label='edit-patient'
                            size={{ lg: 'sm' }}
                          >
